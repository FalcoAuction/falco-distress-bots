...
def get_allowed_counties_base() -> set[str]:
    ...
    raw = os.getenv(
        ...
        "Davidson,Williamson,Rutherford,Sumner,Wilson,Maury,Montgomery,Cheatham,Robertson,Dickson,Knox,Hamilton,Blount,Sevier,Washington,Cumberland,Putnam,Sullivan",
    )
    vals: list[str] = []
