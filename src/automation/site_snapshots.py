...
def _build_candidate_listing_payload(
    ...
    return {
        ...
        "contactTargetRole": _field("contact_target_role"),
        "saleControllerName": _field("sale_controller_contact_name"),
        "saleControllerPhonePrimary": _field("sale_controller_phone_primary"),
        "saleControllerPhoneSecondary": _field("sale_controller_phone_secondary"),
        "saleControllerContactSource": _field("sale_controller_contact_source"),
        ...
        row.update(
            {
                ...
                "contactTargetRole": hydrated.get("contact_target_role"),
                "saleControllerName": hydrated.get("sale_controller_contact_name"),
                "saleControllerPhonePrimary": hydrated.get("sale_controller_phone_primary"),
                "saleControllerPhoneSecondary": hydrated.get("sale_controller_phone_secondary"),
                "saleControllerContactSource": hydrated.get("sale_controller_contact_source"),
...
def _build_prefc_partner_desk(
    ...
    for row in live_rows:
        ...
        entry = {
            ...
            "saleControllerPhoneSecondary": row.get("saleControllerPhoneSecondary"),
